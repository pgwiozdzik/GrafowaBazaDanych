...
// --- IMPORTY OBRAZKÓW ---
// Vite automatycznie zamieni to na poprawne ścieżki do plików
        ...
        <div style={{ fontFamily: '"Segoe UI", Tahoma, Geneva, Verdana, sans-serif', maxWidth: '900px', margin: '0 auto', padding: '40px', lineHeight: '1.8', color: '#333', background: '#fff' }}>
            ...
            <section style={{ marginBottom: '60px' }}>
                ...
                <div style={{ textAlign: 'center', margin: '30px 0', padding: '10px', border: '1px solid #eee', borderRadius: '8px', background: '#fcfcfc' }}>
                    {/* Używamy zaimportowanej zmiennej */}
                    <img
                        src={imgWdrozenie}
            ...
            <section style={{ marginBottom: '60px' }}>
                ...
                <p>
                    Dostępność książki jest realizowana dynamicznie poprzez relację <code>:BORROWED</code>.
                </p>
                ...
                <div style={{ textAlign: 'center', margin: '30px 0', padding: '10px', border: '1px solid #eee', borderRadius: '8px', background: '#fcfcfc' }}>
                    ...
                    />
                    <p style={{ fontSize: '13px', color: '#7f8c8d', marginTop: '10px', fontStyle: 'italic' }}>
                        Rys. 2. Schemat węzłów i krawędzi w bazie Neo4j.
                    </p>
                </div>
            </section>
            ...
            <section style={{ marginBottom: '60px' }}>
                ...
                <ul style={{ listStyleType: 'disc', paddingLeft: '20px' }}>
                    <li><strong>Wyszukiwanie (Guest):</strong> Zaawansowane filtrowanie po tytule, autorze lub roku.</li>
                    <li><strong>Rekomendacje (Guest):</strong> System analizuje historię wypożyczeń.</li>
                    <li><strong>Zarządzanie (User):</strong> Wypożyczanie, zwrot, dodawanie i usuwanie książek.</li>
                </ul>
